...
def main():
    ...
    st.markdown(
        ...
        <h1 class="main-title">🦅 Hawk's Studio</h1>
    ...
    with tabs[0]:
        ...
        # Generate button
        if st.button("🚀 Generate Images", type="primary", key="generate_images_btn"):
    ...
    with tabs[2]:
        ...
        if uploaded_file:
            ...
            with col1:
                ...
                if st.button("🎨 Generate", type="primary", key="fill_generate_btn"):
                    if not prompt:
